...
const en = {
  ...
  explore: {
    ...
    topup: {
      heading: "Top up with USDT",
      desc: "Buy credits with crypto. 1 USDT = 32 credits.",
      cta: "Top up",
    },
  },
  topup: {
    title: "Top up",
    heading: "Top up with USDT",
    desc: "Add credits by sending USDT (Tether) to your personal deposit address. The rate is fixed: 1 USDT = 32 credits, and whatever you send is credited automatically.",
    addressHeading: "Your USDT deposit address",
    addressDesc: "Send USDT to this address. It's yours — reuse it any time, on any supported network below.",
    copyAddress: "Copy address",
    copied: "Copied!",
    rateNote: "Rate · 1 USDT = {rate} credits",
    networksLabel: "Supported networks",
    important: "Send only USDT, and only on one of the supported networks above. Other tokens or networks may be lost permanently.",
    estimatorLabel: "How many credits will I get?",
    estimatorPlaceholder: "USDT amount",
