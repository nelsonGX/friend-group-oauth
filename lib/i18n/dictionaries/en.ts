...
const en = {
  ...
  explore: {
    ...
    topup: {
      heading: "Top up with USDT / USDC",
      desc: "Buy credits with crypto. 1 USDT or USDC = 32 credits.",
      cta: "Top up",
    },
  },
  topup: {
    title: "Top up",
    heading: "Top up with USDT / USDC",
    desc: "Add credits by sending USDT or USDC (USD stablecoins) to your personal deposit address. The rate is fixed: 1 USDT/USDC = 32 credits, and whatever you send is credited automatically.",
    addressHeading: "Your stablecoin deposit address",
    addressDesc: "Send USDT or USDC to this address. It's yours — reuse it any time, on any supported network below.",
    copyAddress: "Copy address",
    copied: "Copied!",
    rateNote: "Rate · 1 USDT/USDC = {rate} credits",
    networksLabel: "Supported networks",
    important: "Send only USDT or USDC, and only on one of the supported networks above. Other tokens or networks may be lost permanently.",
    estimatorLabel: "How many credits will I get?",
    estimatorPlaceholder: "USDT/USDC amount",
    estimatorResult: "≈ {credits} credits",
    refresh: "Check for deposits",
    refreshing: "Checking the blockchain…",
    refreshHint: "Deposits are also picked up automatically within a minute or two.",
    disabledTitle: "Top-ups aren't available",
    disabledDesc: "Crypto top-ups haven't been configured on this server yet.",
    notAllowed: "You need access before you can top up.",
    historyHeading: "Your deposits",
    noDeposits: "No deposits yet. Send USDT to your address above and it'll show up here.",
    thDate: "Date",
    thNetwork: "Network",
    thAmount: "Amount",
    thCredits: "Credits",
  ...
  dashboard: {
    ...
    appFund: "Funded {name}",
    appWithdrawal: "From {name} app balance",
    ...
    forms: {
      ...
      fundAmountPlaceholder: "Amount (+ to fund, - to withdraw)",
      fundReasonPlaceholder: "Reason (optional)",
      funding: "Updating…",
      updateAppBalance: "Update app balance",
  ...
  dashboardActions: {
    ...
    appFundInvalidAmount: "Enter a non-zero whole number of credits.",
    appFundInsufficient: "Your balance is too low. Current balance: {balance}.",
    appFunded: "Added {amount} credits. App balance: {balance}.",
    appWithdrawInvalidAmount: "Enter a positive whole number of credits.",
    appWithdrawInsufficient:
      "The app balance is too low. Current app balance: {balance}.",
    appWithdrawn:
      "Moved {amount} credits to your balance. App balance: {balance}.",
